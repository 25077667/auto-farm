...
#func, func   \
    ...
    struct string_view
    {
        ...
        string_view(const char *begin, const char *end) : begin{begin},
                                                          end{end},
                                                          len{size_t(end - begin)} {}
        string_view(const char *string_literal) : begin{string_literal},
                                                  end{strchr(string_literal, '\0')},
                                                  len{size_t(end - begin)} {}
        string_view() = delete;
...
// Format:
// <cmd> = (<key>:<value>' ')*\n
// <key>,<value> are non-whitespace strings, both of them could not have ':' char
// each <key>,<value> pair has a whitespace at the end
...
// "1" is enable
// "0" is disable
void detail::active_relay(const string_view &s)
{
    relay(*s.begin ^ '0');
}
